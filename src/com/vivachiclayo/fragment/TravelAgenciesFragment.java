...
import com.vivachiclayo.directory.TravelAgencies;;


public class TravelAgenciesFragment extends Fragment {
	 private LinearLayout layout;	 
	 private TravelAgencies.contentItem mItem;
	 private ImageButton btnLlamar;
	 
	 public TravelAgenciesFragment() {
	    }
	 ...
	 public void onCreate(Bundle savedInstanceState) {
			...
			this.getActivity().setTitle(R.string.agencies);
		...
		for (int i = 0; i <  TravelAgencies.ITEMS.size(); i++) {
			mItem = TravelAgencies.ITEMS.get(i);	
			
			LinearLayout contenedorAgenda = (LinearLayout)  inflater.inflate(R.layout.contendor_agenda_travelguides, null, false);
		    ...
		    TextView textDireccion = (TextView) contenedorAgenda.findViewById(R.id.textoDireccion);
		    TextView textWeb = (TextView) contenedorAgenda.findViewById(R.id.textoWeb);
		    ...
		    textDireccion.setText(mItem.direccion);
		    textWeb.setText("Web: " + mItem.web);
